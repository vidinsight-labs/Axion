...
class WorkerProcess:
    ...
    def __getstate__(self):
        ...
        state = {
            ...
            '_status_pipe': self._status_pipe,
            '_child_status_pipe': self._child_status_pipe,
            '_executor_func': None,
    ...
    def __setstate__(self, state):
        ...
        self._status_pipe = state['_status_pipe']
        self._child_status_pipe = state['_child_status_pipe']
        self._executor_func = None
        self._process = None
    
    @staticmethod
    def _run_process(cmd_pipe, status_pipe, output_queue, executor_func, max_threads, worker_id):
